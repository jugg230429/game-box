...
class BindDiscountValidate extends Validate
{
    protected $rule = [
            ...
            'game_user_account'=>'requireIf:type,5'
    ];
    protected $message = [
            'type' => '折扣对象参数错误',
            ...
            'promote_ids'=>'推广员不能为空',
            'game_user_account'=>'游戏玩家不能为空'
    ];
    protected $scene = [
            'edit' => ['first_discount', 'continue_discount', 'promote_ids','game_user_account'],
    ];
    ...
    protected function checktype($value,$rule,$data){
        ...
        $rebate = Db::table('tab_spend_bind_discount')->field('id')->where($map)->find();
