...
class GameValidate extends Validate
{
    ...
    protected $rule = [
        ...
        'game_appid' => 'require',
        //'add_game_address' => 'requireIf:down_port,2&requireIf:sdk_version,1',
        //'ios_game_address' => 'requireIf:down_port,2&requireIf:sdk_version,2',
        ...
        'bind_continue_recharge_discount' => 'require|between:0.01,10',
        'game_key' => 'length:1,32',
        'access_key' => 'length:1,32',
    ];
    protected $message = [
        ...
        //'add_game_address' => '第三方下载链接不能为空',
        //'ios_game_address' => '第三方下载链接不能为空',
        ...
        'discount' => '代充折扣错误',
        'bind_recharge_discount'=> '绑币首充折扣错误',
        'bind_continue_recharge_discount'=> '绑币续充折扣错误',
        'game_key' => '游戏KEY不能超过32个字符',
        'access_key' => '访问秘钥不能超过32个字符',
    ];
    protected $scene = [
        'edit' => ['game_type_id', 'add_game_address', 'ios_game_address', 'game_address_size', 'ratio', 'money', 'sort', 'game_score', 'recommend_level', 'discount', 'game_key', 'access_key','bind_recharge_discount','bind_continue_recharge_discount'],
    ];
