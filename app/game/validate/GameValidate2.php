...
class GameValidate2 extends Validate
{
    ...
    protected $message = [
        ...
        'currency_name'=>'游戏币名称不能为空',
        'currency_ratio'=>'游戏币充值比例不能为空',
        'ratio' => '分成比例不正确',
        'money' => '推广注册CPA单价不能为空',
        'sort' => '排序必须是数字',
    ...
    protected $scene = [
        'edit' => ['game_type_id','currency_name','currency_ratio', 'ratio', 'money', 'sort', 'game_score', 'recommend_level', 'discount', 'game_key', 'bind_recharge_discount'],
    ];
