...
def convert_to_standard_string(input_string):
    ...
    if isinstance(input_string, unicode):
        return input_string.encode(bcecli.baidubce.DEFAULT_ENCODING)
    else:
...
def parse_host_port(endpoint, default_protocol):
    ...
    :type: bcecli.baidubce.protocol.HTTP or bcecli.baidubce.protocol.HTTPS
    ...
    if parse_result.scheme == bcecli.baidubce.protocol.HTTP.name:
        protocol = bcecli.baidubce.protocol.HTTP
        port = bcecli.baidubce.protocol.HTTP.default_port
    elif parse_result.scheme == bcecli.baidubce.protocol.HTTPS.name:
        protocol = bcecli.baidubce.protocol.HTTPS
        port = bcecli.baidubce.protocol.HTTPS.default_port
    else:
