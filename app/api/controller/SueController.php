...
use think\Request;
use think\Db;
class SueController extends HomeBaseController
{
    ...
    public function createorder()
    {
        ...
        //获取游戏信息
        $mGame = new GameModel();
        $field = 'id,game_name,game_appid,pay_status,weiduan_pay_status';
        $where = [];
    ...
    public function paynotice()
    {
        ...
        $spend->pay_status = $data['pay_status'];
        $spend->pay_game_status = $data['game_pay_status'];
        $result = $spend->save();
        if($result !== false){
            echo  'success';exit;
        }
