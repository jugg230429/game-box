...
class BaseController extends HomeBaseController
{
    ...
    protected function _initialize()
    {
        ...
        $array = ['apple_alipay_pay', 'apple_weixin_pay', 'get_alipay_zmxy_return', 'apple_platform_pay', 'notice', 'pay_way', 'pay_success2', 'pay_success','protocol','coupon','get_pay_coupon','init'];
