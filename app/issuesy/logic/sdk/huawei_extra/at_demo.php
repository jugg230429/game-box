 ...
 */
class AtDemo {
    private static $CLIENT_ID = ""; //your appId
    private static $CLIENT_SECRET = ""; // your app secret
    private static $TOKEN_URL = ""; //token url to get the authorization
    private static  $accessToken = null;

    public function __construct($CLIENT_ID,$CLIENT_SECRET,$TOKEN_URL='https://oauth-login.cloud.huawei.com/oauth2/v3/token')
    {
    ...
    public static function getAppAT() {
        ...
        $dataArray= array("grant_type"=>$grant_type,"client_id"=>AtDemo::$CLIENT_ID,
            "client_secret"=>AtDemo::$CLIENT_SECRET);
