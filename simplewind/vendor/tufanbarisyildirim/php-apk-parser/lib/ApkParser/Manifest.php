...
class Manifest extends Xml
{
    ...
    public static $permissions = array(
        ...
        'REQUEST_INSTALL_PACKAGES'             => 'Allows an application to request installing packages. Apps targeting APIs greater than 25 must hold this permission in order to use ACTION_INSTALL_PACKAGE',
        ...
        'UNINSTALL_SHORTCUT'                   => 'Allows an application to uninstall a shortcut in Launche.r',
