...
if (!function_exists('get_upgrade_domain')) {
    ...
    {
        $str = "WVVoU01HTklUVFpNZVRsdFpGaGtNVXh1V25Oak1sSnlURzFPZG1KUlBUMD0=";
        return base64_decode(base64_decode(base64_decode($str)));
    }
}
if (!function_exists('get_from_code')) {
    function get_from_code()
    {
        $upgradefile = WEB_ROOT . '../data/' . base64_decode("dXBncmFkZV9jb2RlLnR4dA==");
        $upgradeconfig = json_decode(file_get_contents($upgradefile), true);
        return $upgradeconfig['from'];
    }
}
if (!function_exists('get_system_version')) {
    function get_system_version()
    {
        $upgradeversion = WEB_ROOT . '../data/' . base64_decode("dXBncmFkZV92ZXJzaW9uLnR4dA==");
