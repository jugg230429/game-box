...
class Storage
{
     ...
     * @param int $tmp_flag 额外标志 为1 原包上传
     * @return mixed
     */
    public function upload($file, $filePath, $fileType = 'image', $param = null,$tmp_flag=0)
    {
        return $this->driver->upload($file, $filePath, $fileType, $param,$tmp_flag);
    }
     ...
     *
     * @author: 郭家屯
     * @since: 2020/8/7 16:12
     */
    public function delete_file($file)
    {
        return $this->driver->file_del($file);
    }
