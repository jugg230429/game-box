...
function change(v){
    ...
    /**
     ...
     var province=$("#certification_province").val(); */
        ...
        if(v && document.getElementById(s[v-1]).selectedIndex>0 || !v){
            if(dsy.Exists(str)){
                ...
                for(i=0;i<ar.length;i++){
                    ...
                    //n++;
                    //ht+= "INSERT INTO tbl_oa_city (city,province,id) VALUES ('"+ar[i]+"', '"+province+"', "+(now*100+n)+");<br/>";
                }//end for
...
dsy.add("0",["北京市","天津市","上海市","重庆市","河北省","山西省","内蒙古","辽宁省","吉林省","黑龙江省","江苏省","浙江省","安徽省","福建省","江西省","山东省","河南省","湖北省","湖南省","广东省","广西省","海南省","四川省","贵州省","云南省","西藏","陕西省","甘肃省","青海省","宁夏","新疆","香港","澳门","台湾"]);
...
dsy.add("0_15_16",["牡丹区","曹县","曹城镇","定陶县","定陶镇","成武县","成武镇","单县","单城镇","巨野县","巨野镇","郓城县","郓城镇","鄄城县","鄄城镇","东明县"]);
...
dsy.add("0_16_2",["湖滨区","义马市","灵宝市","渑池县","陕县","大营镇","卢氏县"]);
...
dsy.add("0_16_7",["北关区","文峰区","殷都区","龙安区","林州市","安阳县","安阳市北关区","汤阴县","滑县","道口镇","内黄县"]);
...
dsy.add("0_16_11",["源汇区","郾城区","召陵区","舞阳县","舞泉镇","临颍县"]);
dsy.add("0_16_12",["新华区","卫东区","湛河区","石龙区","舞钢市","汝州市","宝丰县","叶县","昆阳镇","鲁山县","鲁阳镇","郏县"]);
dsy.add("0_16_13",["卧龙区","宛城区","邓州市","南召县","方城县","西峡县","镇平县","内乡县","淅川县","社旗县","赊店镇","唐河县","新野县","桐柏县"]);
...
dsy.add("0_17_4",["孝南区","应城市","安陆市","汉川市","孝昌县","花园镇","大悟县","云梦县"]);
...
dsy.add("0_27_0",["城关区","七里河区","西固区","安宁区","红古区","永登县","皋兰县","石洞镇","榆中县"]);
dsy.add("0_27_1",["金昌市","金川区","永昌县"]);
...
dsy.add("0_27_7",["西峰区","庆城县","庆城镇","环县","环城镇","华池县","柔远镇","合水县","西华池镇","正宁县","山河镇","宁县","新宁镇","镇原县"]);
dsy.add("0_27_8",["崆峒区","泾川县","灵台县","中台镇","崇信县","锦屏镇","华亭县","东华镇","庄浪县","水洛镇","静宁县"]);
dsy.add("0_27_9",["安定区","通渭县","平襄镇","临洮县","洮阳镇","漳县","武阳镇","岷县","岷阳镇","渭源县","清源镇","陇西县","巩昌镇"]);
dsy.add("0_27_10",["武都区","成县","宕昌县","康县","文县","西和县","汉源镇","礼县","两当县","徽县"]);
...
dsy.add("0",["北京市","天津市","上海市","重庆市","河北省","山西省","内蒙古","辽宁省","吉林省","黑龙江省","江苏省","浙江省","安徽省","福建省","江西省","山东省","河南省","湖北省","湖南省","广东省","广西省","海南省","四川省","贵州省","云南省","西藏","陕西省","甘肃省","青海省","宁夏","新疆","香港特别行政区","澳门特别行政区","台湾"]);

//var s=["s_province","s_city","s_county"];//三个select的name
var s=[];
var opt0 = ["省","市","区/县"];//初始值
function _init_area(province,city,county){  //初始化函数//二级联动的name通过形参传入
