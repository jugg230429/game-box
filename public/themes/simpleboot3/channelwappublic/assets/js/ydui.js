...
!function (window) {
    ...
    CitySelect.prototype.open = function () {
        ...
        $cityElement.before('<div class="m-cityselect-shade"></div>');
    };
    ...
    CitySelect.prototype.close = function () {
        ...
        _this.$itemBox.html('');
        _this.$cityElement.siblings('.m-cityselect-shade').remove();

        if(typeof window.selectCityCallback == 'function') {
            window.selectCityCallback();
        }
