...
(function () {
     ...
     */
	var simpleuploadcfg = navigator.userAgent.indexOf('Firefox') >= 0?'':'simpleupload';//火狐不能单图上传
    window.UEDITOR_CONFIG = {
        ...
        , toolbars: [[
			...
			simpleuploadcfg, 'insertimage', 'emotion', /*'scrawl',*/ 'insertvideo', 'music', 'attachment', 'map', /*'gmap',*/ 'insertframe', 'insertcode', /*'webapp',*/ 'pagebreak', 'template', 'background', '|',
